...
<form class='add-form' id='mapForm' action='<?php echo $_SERVER['PHP_SELF']; ?>' method="post" onsubmit="return validateAddMap()">
    <table class='add-form'>
        <tr>
            ...
            <td class="add-form error-message" id='mapTitleError' style="text-align:left;"></td>
        </tr>
        <tr>
            <td>
            ...
            <td class="add-form error-message" id='mapAuthorError' style="text-align:left;"></td>
        </tr>
        <tr>
            <td>
            ...
            <td class="add-form error-message" id='mapPublishDateError' style="text-align:left;"></td>
        </tr>
        <tr>
            <td>
            ...
            <td class="add-form error-message" id='mapLocationError' style="text-align:left;"></td>
        </tr>
        <tr>
            <td>
            ...
            <td class="add-form error-message" id='mapDimensionsError' style="text-align:left;"></td>
        </tr>
        <tr>
            <td>
            ...
            <td class="add-form error-message" id='mapColoringError' style="text-align:left;"></td>
        </tr>
        <tr>
            <td>
            ...
            <td class="add-form error-message" id='mapPriceError' style="text-align:left;"></td>
        </tr>
        <tr>
            <td>
            ...
            <td class="add-form error-message" id='mapPricingDateError' style="text-align:left;"></td>
        </tr>
        <tr>
            <td>
            ...
            <td class="add-form error-message" id='mapConditionGradeError' style="text-align:left;"></td>
        </tr>
        <tr>
            <td>
            ...
            <td class="add-form error-message" id='mapAcquisitionPriceError' style="text-align:left;"></td>
        </tr>
        <tr>
            <td>
            ...
            <td class="add-form error-message" id='mapInStockError' style="text-align:left;"></td>
        </tr>
        <tr>
            <td>
            ...
            <td class="add-form error-message" id='mapDescriptionError' style="text-align:left;"></td>
        </tr>
        <tr>
            <td>
            ...
            <td class="add-form error-message" id='mapConditionDescriptionError' style="text-align:left;"></td>
        </tr>
        <tr>
            <td>
                &nbsp;
